...
```toml
[dependencies]
bevy-steamworks = { git = "https://github.com/UhDylan/bevy_steamworks", features = ["serde"] }
```
...
The plugin will automatically call `SteamworksSingleClient::run_callbacks` on the Bevy
